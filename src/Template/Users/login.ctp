...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $this->Url->build(array('controller' => 'pages', 'action' => 'dashboard',)); ?>"><?php echo Configure::read('Theme.logo.large'); ?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo __('Inicie sesión en el sistema.') ?></p>
...
<?php echo $this->fetch('content'); ?>
    ...
    <?= $this->Form->button(__('Ingresar'),['action'=>'login']); ?>
    <?= $this->Form->end() ?>
